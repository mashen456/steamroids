...
| 05 | [`05_signin_refresh_token.rs`](./05_signin_refresh_token.rs) | `SignIn` builder for refresh-token reuse + optional proxy, hits `GenerateAccessTokenForApp` | Yes (api.steampowered.com) | ✅ live |
